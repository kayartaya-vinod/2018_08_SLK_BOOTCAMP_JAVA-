...
public class PhonebookApp {
	...
	public PhonebookApp() throws DaoException {
		...
		// call ctx.close() when the user quits.
		dao = ctx.getBean(ContactsDao.class);
	}
	...
	private void printContacts(List<Contact> list) {
		...
		line("-");
		for (Contact c : list) {
			String title = c.getGender().equals("Male") ? "Mr." : "Ms.";
	...
	private void printContactDetails(Contact contact) {
		String title = contact.getGender().equals("Male") ? "Mr." : "Ms.";
